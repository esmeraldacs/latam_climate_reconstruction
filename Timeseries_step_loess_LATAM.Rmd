...
plot1 <- single_envelope1 |>
  ...
  theme(strip.background = element_rect(fill="transparent",colour="transparent"),
        strip.text = element_text(hjust = 0, vjust = -0.5,face = "bold", size = 8),
...
```{r}
ggsave(plot=plot1, "Output_figures/all fossil entitites in latam.png",units = "cm", width = 16, height = 10)
```
